...
const CIRCUITS: Circuit[] = [
  ...
  },
  {
    ...
    visual: '🌡️ Data ── GPIO 4 (with 10kΩ Pull-up to 3.3V VCC) | GND ── GND'
  },
  {
    ...
    visual: '⚙️ Orange PWM ── GPIO 18 | Red VCC ── 5V External | Shared GND ── GND'
  }
];
            ...
            <div key={i} className={`glass-card ${styles.card}`}>
              ...
              <div className={styles.body}>
                ...
                <div className={styles.sectionDetail} style={{ marginTop: 16 }}>
                  <strong>⚙️ Working Principle:</strong>
                  <p>{c.working}</p>
                </div>
